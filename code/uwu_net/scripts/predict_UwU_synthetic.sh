...
python predict.py \
       ...
       --path_dataset_csv "../../data/dbs/inform_${DATASET}/${TEST_OR_TRAIN}.csv"\
       --n_images ${N_IMAGES} \
       --no_signal \
       --no_prediction_unpropped \
       --path_save_dir "../../data/dbs/inform_${DATASET}/results/${TEST_OR_TRAIN}" \
       --gpu_ids ${GPU_IDS} \
